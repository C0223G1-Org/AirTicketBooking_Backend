...
public class CustomerDto implements Validator {
    ...
    @Size(max = 100, min = 3, message = "Họ và tên tối thiểu 3 ký tự và tối đa 10 ký tự ")
...
//    @NotBlank(message = "Không được để trống trường này")
    ...
    @NotBlank(message = "Không được để trống trường này")
    @Size(min = 12,max = 50,message = "Email tối thiểu 6 ký tự và tối đa 50 ký tự")
    ...
    public void validate(Object target, Errors errors) {
        ...
        try {
            ...
            if (period.getYears() < 18 || period.getYears()>100) {
                errors.rejectValue("dateCustomer", "dateCustomer", "Khách hàng phải trên 18 tuổi và không quá 100 tuổi");
            } else if (period.getYears() == 18 || period.getYears() == 100) {

...
public class PaymentController {
    ...
    public ResponseEntity<String> updateTicketByIdTicket(@PathVariable Long id, @PathVariable("message") String paymentStatus) throws MessagingException, UnsupportedEncodingException {

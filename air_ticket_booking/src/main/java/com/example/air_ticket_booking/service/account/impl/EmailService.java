...
//    }
    public void sendMail(String to, Integer number) throws MessagingException, UnsupportedEncodingException {
        ...
        String senderName = "CodeGym AirLines";
        String subject = "Mã xác nhận đăng ký tài khoản CodeGym AirLines";
        String content = "<div style=\"font-family: Arial, sans-serif;\n" +
                ...
                "            font-size: 24px;\n" +
                "            margin-bottom: 20px;\">Mã xác nhận đăng ký tài khoản CodeGym AirLines</h2>\n" +
                ...
                "        <br>\n" +
                "        <br>\n" +
                "        <p>Cảm ơn bạn đã chọn CodeGymAirLines!</p>\n" +
                "    </div>\n" +
                "</div>" +
                "\n" + "\n" + "\n" + "\n" +
                "CodeGymAirLines"+ "\n"+

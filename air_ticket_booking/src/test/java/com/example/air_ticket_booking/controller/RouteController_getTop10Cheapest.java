...
public class RouteController_getTop10Cheapest {
    ...
    public void getTop10Cheapest_6() throws Exception {
        this.mockMvc.perform(
                ...
                .andExpect(jsonPath("[0].nameDestination").value("Cát Bi(HPH) - Hải Phòng"))
                .andExpect(jsonPath("[0].nameAirCraft").value("Airbus A320neo"))
                ...
                .andExpect(jsonPath("[9].nameDeparture").value("Cát Bi(HPH) - Hải Phòng"))
                .andExpect(jsonPath("[9].nameDestination").value("Cát Bi(HPH) - Hải Phòng"))
                .andExpect(jsonPath("[9].nameAirCraft").value("Airbus A320neo"));
    }
    ...
    public void getTop10Cheapest_7() throws Exception {
        this.mockMvc.perform(
                ...
                .andExpect(jsonPath("[0].nameDeparture").value("Đà Lạt(DLI)"))
                .andExpect(jsonPath("[0].nameDestination").value("Hồ Chí(SGN)"))
                ...
                .andExpect(jsonPath("[3].nameDeparture").value("Đà Lạt(DLI)"))
                .andExpect(jsonPath("[3].nameDestination").value("Hồ Chí(SGN)"))
                .andExpect(jsonPath("[3].nameAirCraft").value("Airbus A350-900 XWB"));
    }
}
